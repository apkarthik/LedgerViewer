...
- 📱 **WhatsApp Sharing**: Share ledger statements directly to WhatsApp as PDF or Image with automatic country code prefix
...
4. **Share via WhatsApp**:
   - From the ledger view, tap the share button and select **WhatsApp (PDF)** or **WhatsApp (Image)**
   - Enter the recipient's 10-digit mobile number (country code will be added automatically)
