    ...
    try {
      ...
      if (dateStr.contains('-')) {
        ...
        if (parts.length == 3) {
          ...
          if (parts[0].length == 4) {
            final year = parts[0].length > 2 ? parts[0].substring(2) : parts[0]; // Last 2 digits of year
            ...
            final month = parts[1].padLeft(2, '0');
            final year = parts[2].length > 2 ? parts[2].substring(2) : parts[2]; // Last 2 digits of year
            return '$day/$month/$year';
          } else {
